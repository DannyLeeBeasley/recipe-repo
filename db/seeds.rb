...
tortellini_soup = Recipe.create(user_id: 1, name: "Tortellini Soup", image: "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2014/2/19/0/FN_Spinach-Tortellini-Soup_s4x3.jpg.rend.hgtvcom.826.620.suffix/1392869571244.jpeg", description: "Papaw's recipe; a favorite of his in his workplace cafeteria, he ate it every week and tried to recreate it until he honed in on this recipe.")
...
thai_drunken_noodles = Recipe.create(user_id: 2, name: "Thai Drunken Noodles", image: "https://data.thefeedfeed.com/static/2020/02/28/15829232455e597dede79c2.jpg", description: "Get your veggies in AND get your pasta fix with this gluten free comfort bowl!")
