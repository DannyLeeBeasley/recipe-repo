...
tortellini_soup_baby_spinach = RecipeIngredient.create(recipe_id: 1, ingredient_id: 19, amount: 2, unit: "C")
tortellini_soup_white_onion = RecipeIngredient.create(recipe_id: 1, ingredient_id: 20, amount: 1, unit: "")
tortellini_soup_garlic = RecipeIngredient.create(recipe_id: 1, ingredient_id: 24, amount: 2, unit: "Cloves")
tortellini_soup_diced_tomatoes = RecipeIngredient.create(recipe_id: 1, ingredient_id: 34, amount: 45, unit: "Oz")
tortellini_soup_cheese_tortellini = RecipeIngredient.create(recipe_id: 1, ingredient_id: 43, amount: 12, unit: "Oz")
tortellini_soup_italian_sausage = RecipeIngredient.create(recipe_id: 1, ingredient_id: 50, amount: 1, unit: "Lbs")
tortellini_soup_chicken_broth = RecipeIngredient.create(recipe_id: 1, ingredient_id: 60, amount: 48, unit: "Oz")

enchiladas_tomatillos = RecipeIngredient.create(recipe_id: 2, ingredient_id: 26, amount: 1, unit: "Lbs")
enchiladas_white_onion = RecipeIngredient.create(recipe_id: 2, ingredient_id: 20, amount: 1.5, unit: "")
enchiladas_garlic = RecipeIngredient.create(recipe_id: 2, ingredient_id: 24, amount: 7, unit: "Cloves")
enchiladas_fresh_jalepeno = RecipeIngredient.create(recipe_id: 2, ingredient_id: 30, amount: 2, unit: "")
...
enchiladas_fresh_cilantro = RecipeIngredient.create(recipe_id: 2, ingredient_id: 17, amount: 1, unit: "C")
enchiladas_lime = RecipeIngredient.create(recipe_id: 2, ingredient_id: 32, amount: 0.5, unit: "")
enchiladas_extra_virgin_olive_oil = RecipeIngredient.create(recipe_id: 2, ingredient_id: 55, amount: 2, unit: "Tbls")
enchiladas_all_purpose_flour = RecipeIngredient.create(recipe_id: 2, ingredient_id: 38, amount: 0.25, unit: "C")
enchiladas_chicken_broth = RecipeIngredient.create(recipe_id: 2, ingredient_id: 60, amount: 2, unit: "C")
enchiladas_shredded_rotisserie_chicken = RecipeIngredient.create(recipe_id: 2, ingredient_id: 53, amount: 3, unit: "C")
enchiladas_fresh_cracked_black_pepper = RecipeIngredient.create(recipe_id: 2, ingredient_id: 2, amount: 2, unit: "Tsp")
enchiladas_large_flour_tortillas = RecipeIngredient.create(recipe_id: 2, ingredient_id: 40, amount: 10, unit: "")
enchiladas_monterey_jack_cheese = RecipeIngredient.create(recipe_id: 2, ingredient_id: 46, amount: 0.5, unit: "Lbs")

skirt_steak_chimichurri_skirt_steak = RecipeIngredient.create(recipe_id: 3, ingredient_id: 52, amount: 1.5, unit: "Lbs")
skirt_steak_chimichurri_fresh_parsley = RecipeIngredient.create(recipe_id: 3, ingredient_id: 16, amount: 3, unit: "C")
skirt_steak_chimichurri_fresh_mint = RecipeIngredient.create(recipe_id: 3, ingredient_id: 18, amount: 0.5, unit: "C")
skirt_steak_chimichurri_fresh_oregano = RecipeIngredient.create(recipe_id: 3, ingredient_id: 14, amount: 0.5, unit: "C")
skirt_steak_chimichurri_canola_oil = RecipeIngredient.create(recipe_id: 3, ingredient_id: 56, amount: 0.5, unit: "C")
skirt_steak_chimichurri_red_wine_vinegar = RecipeIngredient.create(recipe_id: 3, ingredient_id: 64, amount: 0.25, unit: "C")
skirt_steak_chimichurri_crushed_red_pepper = RecipeIngredient.create(recipe_id: 3, ingredient_id: 3, amount: 1.5, unit: "Tsp")
skirt_steak_chimichurri_garlic = RecipeIngredient.create(recipe_id: 3, ingredient_id: 23, amount: 24, unit: "Cloves")
skirt_steak_chimichurri_extra_virgin_olive_oil = RecipeIngredient.create(recipe_id: 3, ingredient_id: 55, amount: 0.5, unit: "C")
skirt_steak_chimichurri_fresh_oregano_finely_chopped = RecipeIngredient.create(recipe_id: 3, ingredient_id: 14, amount: 2, unit: "Tbls")
skirt_steak_chimichurri_chipotle_in_adobo = RecipeIngredient.create(recipe_id: 3, ingredient_id: 35, amount: 1, unit: "Tlbs")
...
thai_drunken_noodles_wide_rice_noodles = RecipeIngredient.create(recipe_id: 4, ingredient_id: 41, amount: 8, unit: "Oz")
thai_drunken_noodles_soy_sauce = RecipeIngredient.create(recipe_id: 4, ingredient_id: 61, amount: 0.33, unit: "C")
thai_drunken_noodles_oyster_sauce = RecipeIngredient.create(recipe_id: 4, ingredient_id: 62, amount: 3, unit: "Tbls")
thai_drunken_noodles_fish_sauce = RecipeIngredient.create(recipe_id: 4, ingredient_id: 63, amount: 1, unit: "Tbls")
thai_drunken_noodles_honey = RecipeIngredient.create(recipe_id: 4, ingredient_id: 69, amount: 2, unit: "Tsp")
thai_drunken_noodles_refined_sesame_oil = RecipeIngredient.create(recipe_id: 4, ingredient_id: 57, amount: 2, unit: "Tbsp")
thai_drunken_noodles_chicken_breast = RecipeIngredient.create(recipe_id: 4, ingredient_id: 73, amount: 1, unit: "C")
thai_drunken_noodles_shallots = RecipeIngredient.create(recipe_id: 4, ingredient_id: 22, amount: 2, unit: "")
thai_drunken_noodles_garlic = RecipeIngredient.create(recipe_id: 4, ingredient_id: 24, amount: 3, unit: "Cloves")
thai_drunken_noodles_fresh_fresno = RecipeIngredient.create(recipe_id: 4, ingredient_id: 29, amount: 2, unit: "")
thai_drunken_noodles_zucchini = RecipeIngredient.create(recipe_id: 4, ingredient_id: 31, amount: 1, unit: "")
thai_drunken_noodles_red_bell_pepper = RecipeIngredient.create(recipe_id: 4, ingredient_id: 27, amount: 1, unit: "")
thai_drunken_noodles_carrots = RecipeIngredient.create(recipe_id: 4, ingredient_id: 25, amount: 2, unit: "")
thai_drunken_noodles_fresh_basil = RecipeIngredient.create(recipe_id: 4, ingredient_id: 15, amount: 1, unit: "C")
thai_drunken_noodles_green_onion = RecipeIngredient.create(recipe_id: 4, ingredient_id: 23, amount: 4, unit: "")

carbonara_rigatoni = RecipeIngredient.create(recipe_id: 5, ingredient_id: 42, amount: 1, unit: "Lbs")
carbonara_evoo = RecipeIngredient.create(recipe_id: 5, ingredient_id: 55, amount: 0.25, unit: "C")
carbonara_pancetta = RecipeIngredient.create(recipe_id: 5, ingredient_id: 49, amount: 4, unit: "Oz")
carbonara_crushed_red_pepper = RecipeIngredient.create(recipe_id: 5, ingredient_id: 3, amount: 1, unit: "Tsp")
carbonara_garlic = RecipeIngredient.create(recipe_id: 5, ingredient_id: 24, amount: 6, unit: "Cloves")
carbonara_dry_white_wine = RecipeIngredient.create(recipe_id: 5, ingredient_id: 65, amount: 0.5, unit: "C")
carbonara_egg_yolk = RecipeIngredient.create(recipe_id: 5, ingredient_id: 48, amount: 2, unit: "")
carbonara_romano = RecipeIngredient.create(recipe_id: 5, ingredient_id: 44, amount: 0.5, unit: "C")
carbonara_fresh_parsley = RecipeIngredient.create(recipe_id: 5, ingredient_id: 16, amount: 1, unit: "Handful")

chili_ground_beef = RecipeIngredient.create(recipe_id: 6, ingredient_id: 51, amount: 1, unit: "Lbs")
chili_chopped_onion = RecipeIngredient.create(recipe_id: 6, ingredient_id: 20, amount: 1, unit: "C")
chili_garlic = RecipeIngredient.create(recipe_id: 6, ingredient_id: 24, amount: 6, unit: "Cloves")
chili_filtered_water = RecipeIngredient.create(recipe_id: 6, ingredient_id: 59, amount: 0.75, unit: "C")
chili_salt = RecipeIngredient.create(recipe_id: 6, ingredient_id: 1, amount: 1, unit: "Tsp")
chili_fresh_cracked_black_pepper = RecipeIngredient.create(recipe_id: 6, ingredient_id: 2, amount: 1, unit: "Tsp")
chili_chili_powder = RecipeIngredient.create(recipe_id: 6, ingredient_id: 5, amount: 3, unit: "Tbls")
chili_ground_cumin = RecipeIngredient.create(recipe_id: 6, ingredient_id: 6, amount: 3, unit: "Tbls")
chili_ground_cayenne = RecipeIngredient.create(recipe_id: 6, ingredient_id: 7, amount: 0.5, unit: "Tsp")
chili_ground_allspice = RecipeIngredient.create(recipe_id: 6, ingredient_id: 8, amount: 1, unit: "Tsp")
chili_ground_cinnamon = RecipeIngredient.create(recipe_id: 6, ingredient_id: 11, amount: 1, unit: "Tsp")
chili_dried_oregano = RecipeIngredient.create(recipe_id: 6, ingredient_id: 12, amount: 1, unit: "Tbls")
chili_dried_basil = RecipeIngredient.create(recipe_id: 6, ingredient_id: 13, amount: 1, unit: "Tbls")
chili_kidney_beans = RecipeIngredient.create(recipe_id: 6, ingredient_id: 37, amount: 16, unit: "Oz")
chili_black_beans = RecipeIngredient.create(recipe_id: 6, ingredient_id: 36, amount: 16, unit: "Oz")
chili_diced_tomatoes = RecipeIngredient.create(recipe_id: 6, ingredient_id: 34, amount: 32, unit: "Oz")
chili_pumpkin_puree = RecipeIngredient.create(recipe_id: 6, ingredient_id: 33, amount: 2, unit: "Tbls")
chili_lager = RecipeIngredient.create(recipe_id: 6, ingredient_id: 67, amount: 12, unit: "Oz")
chili_red_wine = RecipeIngredient.create(recipe_id: 6, ingredient_id: 66, amount: 1, unit: "C")
chili_hershey_kisses = RecipeIngredient.create(recipe_id: 6, ingredient_id: 71, amount: 2, unit: "")
chili_instant_coffee = RecipeIngredient.create(recipe_id: 6, ingredient_id: 72, amount: 1, unit: "Tsp")
chili_cheddar_cheese = RecipeIngredient.create(recipe_id: 6, ingredient_id: 47, amount: 1, unit: "Cup")
